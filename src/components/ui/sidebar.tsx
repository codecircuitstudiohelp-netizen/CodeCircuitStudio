...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-3 mt-auto group-data-[collapsible=icon]:p-2", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-y-1 overflow-auto p-3 group-data-[collapsible=icon]:p-2",
        className
      )}
      {...props}
    />
